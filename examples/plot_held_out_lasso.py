...
from sparse_ho.optimizers import LineSearch, TrustRegion
...
grid_search(criterion, model, X, y, None, None, monitor_grid_sk, alphas=alphas, tol=tol)
...
ax.set_ylabel(r"$\|y^{\rm{val}} - X^{\rm{val}} \hat \beta^{(\lambda)} \|^2$")
